...
cmake.exe -G"MinGW Makefiles" -DLIBJPEG_TURBO_ROOT="D:/Code Projects/cpp-libraries/libjpeg-turbo-v2.1.3-x86_64-posix-seh-rev0-8.1.0" -DCMAKE_BUILD_TYPE=Debug -B./build &&^
cd build &&^
cmake --build . &&^
